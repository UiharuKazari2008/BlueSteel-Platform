...
& "H:\Blue Steel OS v2\SYSTEM_BLUE_STEEL_ALLS_SDHD_SW_KEY\savior_of_song_keychip.exe" --auth "" --applicationVHD $base --optionVHD $option --editMode --swMode
Read-Host
& "H:\Blue Steel OS v2\SYSTEM_BLUE_STEEL_ALLS_SDHD_SW_KEY\savior_of_song_keychip.exe" --auth "" --applicationVHD $base --optionVHD $option --shutdown --swMode
